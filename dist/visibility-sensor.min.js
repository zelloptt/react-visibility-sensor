                ...
                b(
                  (s = (function(t, e) {
                    return !e || ("object" !== f(e) && "function" != typeof e)
                      ? b(t)
                      : e;
                  })(this, h(e).call(this, t)))
                ),
                "getContainer",
                function() {
                  return s.props.containment || window;
                }
              ),
              m(b(s), "addEventListener", function(t, e, o, n) {
                var r;
                s.debounceCheck || (s.debounceCheck = {});
                function i() {
                  (r = null), s.check();
                }
                var a = {
                ...
                t.addEventListener(e, a.fn), (s.debounceCheck[e] = a);
              }),
              m(b(s), "startWatching", function() {
                s.debounceCheck ||
                  s.interval ||
                  (s.props.intervalCheck &&
                    (s.interval = setInterval(s.check, s.props.intervalDelay)),
                  s.props.scrollCheck &&
                    s.addEventListener(
                      s.getContainer(),
                      "scroll",
                      s.props.scrollDelay,
                      s.props.scrollThrottle
                    ),
                  s.props.resizeCheck &&
                    s.addEventListener(
                      window,
                      "resize",
                      s.props.resizeDelay,
                      s.props.resizeThrottle
                    ),
                  s.props.delayedCall || s.check());
              }),
              m(b(s), "stopWatching", function() {
                if (s.debounceCheck)
                  for (var t in s.debounceCheck)
                    if (s.debounceCheck.hasOwnProperty(t)) {
                      var e = s.debounceCheck[t];
                      clearTimeout(e.getLastTimeout()),
                        e.target.removeEventListener(t, e.fn),
                        (s.debounceCheck[t] = null);
                    }
                (s.debounceCheck = null),
                  s.interval && (s.interval = clearInterval(s.interval));
              }),
              m(b(s), "check", function() {
                var t,
                  e,
                  o = s.node;
                if (!o) return s.state;
                if (
                  ...
                  })(s.roundRectDown(o.getBoundingClientRect()))),
                  s.props.containment)
                ) {
                  var n = s.props.containment.getBoundingClientRect();
                  e = {
                    top: n.top,
                    left: n.left,
                    bottom: n.bottom,
                ...
                var i = {
                  ...
                  a = 0 < t.height && 0 < t.width,
                  l = a && i.top && i.left && i.bottom && i.right;
                if (a && s.props.partialVisibility) {
                  var c =
                    t.top <= e.bottom &&
                    t.bottom >= e.top &&
                    t.left <= e.right &&
                    t.right >= e.left;
                  "string" == typeof s.props.partialVisibility &&
                    (c = i[s.props.partialVisibility]),
                    (l = s.props.minTopValue
                      ? c && t.top <= e.bottom - s.props.minTopValue
                      : c);
                }
                ...
                return (
                  s.state.isVisible !== l &&
                    ((u = { isVisible: l, visibilityRect: i }),
                    s.setState(u),
                    s.props.onChange && s.props.onChange(l, o)),
                  u
                );
              }),
              (s.state = { isVisible: null, visibilityRect: {} }),
              s
            );
          }
          return (
